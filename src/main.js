...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const affectsOnlyOneFolder = rules["limitToSingleFolder"] || undefined;
            const sampleFolderNameRule = rules["folderName"] || undefined;
            const acceptedFolders = (sampleFolderNameRule === null || sampleFolderNameRule === void 0 ? void 0 : sampleFolderNameRule.acceptedFolders) || [];
            const requireVisitorStats = rules["requireVisitorStats"] || false;
